...
\def\Supervisor{Michal Kopecký}

% Supervisor's department (again according to Organizational structure of MFF)
\def\SupervisorsDepartment{}
...
\def\ThesisKeywords{%
SQL\sep Relational Data Model\sep JSON\sep In-memory database
}
...
SQL\sep Relační model dat\sep JSON\sep In-memory databáze
}
